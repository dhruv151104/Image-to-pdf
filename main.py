...
class ImageToPdfConverter:
    ...
    def select_images(self):
        self.image_paths=filedialog.askopenfilenames(title="Select Images",filetypes=[("Image files", '*.jpeg *.jpg *.png *.heic')])
    ...
    def convert_images_to_pdf(self):
        ...
        output_pdf_path=self.output_pdfname.get() + ".pdf" if self.output_pdfname.get() else "output.pdf" 
        ...
        for image_path in self.image_paths:
            ...
            new_width=scale_factor*img.width
            new_height=scale_factor*img.height
